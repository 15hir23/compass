...
const styles = StyleSheet.create({
  ...
  headerGradient: {
    ...
    paddingHorizontal: getResponsiveSize(12),
    ...(Platform.OS === 'web' && {
      boxShadow: '0 4px 16px rgba(244, 196, 48, 0.35), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
    }),
  },
  headerTop: {
    flexDirection: 'row',
  ...
  selectLabel: {
    ...
    ...(Platform.OS === 'web' && {
      textShadow: '0px 1px 2px rgba(184, 134, 11, 0.2)',
    }),
  },
  compassGrid: {
    flexDirection: 'row',
  ...
  card: {
    ...
    position: 'relative',
    ...(Platform.OS === 'web' && {
      boxShadow: '0 6px 20px rgba(244, 196, 48, 0.3), 0 0 0 1px rgba(244, 196, 48, 0.1)',
  ...
  compassPreview: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    height: getResponsiveSize(110), // Fixed height for compass preview
    width: '100%',
