      ...
      <View style={styles.searchContainer}>
                ...
                {suggestions.map((suggestion, index) => (
                  ...
                  >
                    <View style={styles.suggestionIconContainer}>
                      <LocationIcon size={getResponsiveSize(12)} color="#F4C430" />
                    </View>
        ...
        >
          {searching ? (
            ...
            <SearchIcon size={getResponsiveSize(16)} color="#FFFFFF" />
          )}
        </TouchableOpacity>
      ...
      >
        ...
        >
          <View style={[styles.currentLocationContent, { pointerEvents: 'none' }]}>
            <LocationIcon size={getResponsiveSize(14)} color="#FFFFFF" />
...
const styles = StyleSheet.create({
  ...
  suggestionsContainer: {
    ...
    shadowOpacity: 0.3,
    shadowRadius: 8,
    marginBottom: getResponsiveSize(50), // Add space to prevent overlap with button below
  },
  suggestionsList: {
