...
export const VASTU_GRID_9X9 = [
  // Row 0 (North - top row)
  [
    { devta: 'Rog', zone: 'NW', energy: 'positive', color: '#FFC125' }, // Golden Yellow
    { devta: 'Nag', zone: 'NNW', energy: 'neutral', color: '#F0E68C' }, // Khaki (pastel)
    { devta: 'Mukhya', zone: 'NNW', energy: 'neutral', color: '#F0E68C' }, // Khaki (pastel)
    { devta: 'Bhalla', zone: 'N', energy: 'neutral', color: '#FFF8DC' }, // Cornsilk (pastel)
    { devta: 'Soma', zone: 'N', energy: 'positive', color: '#FFD700' }, // Gold
    { devta: 'Bhujang', zone: 'N', energy: 'neutral', color: '#FFF8DC' }, // Cornsilk (pastel)
    { devta: 'Aditi', zone: 'NNE', energy: 'very positive', color: '#FFE87C' }, // Light Gold (lighter)
    { devta: 'Diti', zone: 'NNE', energy: 'positive', color: '#FFC125' }, // Golden Yellow
    { devta: 'Shikhi', zone: 'NE', energy: 'very positive', color: '#FFE87C' }, // Light Gold (lighter)
  ],
  // Row 1
  [
    { devta: 'Papa Yaksha', zone: 'NW', energy: 'negative', color: '#F0A500' }, // Honey Gold
    { devta: 'Rudrajay', zone: 'NW', energy: 'neutral', color: '#FFE87C' }, // Light Gold
    { devta: null, zone: null, energy: null, color: null }, // Empty cell
    { devta: 'Prithvidhara', zone: 'N', energy: 'positive', color: '#FFC125' }, // Merged 3x3 - Golden Yellow
    { devta: 'Prithvidhara', zone: 'N', energy: 'positive', color: '#FFC125' },
    { devta: 'Prithvidhara', zone: 'N', energy: 'positive', color: '#FFC125' },
  ...
  // Row 2
  [
    { devta: 'Sosha', zone: 'WNW', energy: 'negative', color: '#F0A500' }, // Honey Gold
    ...
    { devta: 'Prithvidhara', zone: 'N', energy: 'positive', color: '#FFC125' }, // Merged continues - Golden Yellow
    { devta: 'Prithvidhara', zone: 'N', energy: 'positive', color: '#FFC125' },
    { devta: 'Prithvidhara', zone: 'N', energy: 'positive', color: '#FFC125' },
    ...
    { devta: 'Jayanta', zone: 'E', energy: 'positive', color: '#FFC125' }, // Golden Yellow
  ],
  // Row 3
  [
    { devta: 'Asura', zone: 'WNW', energy: 'negative', color: '#F0A500' }, // Honey Gold
  ...
  // Row 4
  [
    { devta: 'Varuna', zone: 'W', energy: 'neutral', color: '#F7E7CE' }, // Champagne (pastel)
    ...
    { devta: 'Aryama', zone: 'E', energy: 'positive', color: '#FFD700' },
    { devta: 'Surya', zone: 'E', energy: 'positive', color: '#FFC125' }, // Golden Yellow
  ],
  // Row 5
  [
    { devta: 'Pushpadanta', zone: 'W', energy: 'positive', color: '#FFD700' }, // Gold
    { devta: 'Mitra', zone: 'W', energy: 'positive', color: '#FFD700' }, // Merged continues - Gold
    { devta: 'Mitra', zone: 'W', energy: 'positive', color: '#FFD700' },
    { devta: 'Brahma', zone: 'BRAHMASTHAN', energy: 'divine', color: '#FFD700' }, // Merged continues - Pure Gold
    { devta: 'Brahma', zone: 'BRAHMASTHAN', energy: 'divine', color: '#FFD700' },
    ...
    { devta: 'Aryama', zone: 'E', energy: 'positive', color: '#FFD700' }, // Merged continues - Gold
    { devta: 'Aryama', zone: 'E', energy: 'positive', color: '#FFD700' },
    { devta: 'Satya', zone: 'ESE', energy: 'positive', color: '#FFC125' }, // Golden Yellow
  ],
  // Row 6
  [
    { devta: 'Sugriva', zone: 'WSW', energy: 'neutral', color: '#F7E7CE' }, // Champagne (pastel)
    { devta: 'Indraraj', zone: 'W', energy: 'positive', color: '#FFD700' }, // Merged 2 cols - Gold
    { devta: 'Indraraj', zone: 'W', energy: 'positive', color: '#FFD700' },
    { devta: 'Vivaswan', zone: 'S', energy: 'positive', color: '#FFBF00' }, // Merged 3x2 - Amber
    { devta: 'Vivaswan', zone: 'S', energy: 'positive', color: '#FFBF00' },
    { devta: 'Vivaswan', zone: 'S', energy: 'positive', color: '#FFBF00' },
    { devta: 'Svitra', zone: 'SSE', energy: 'positive', color: '#FFD700' }, // Merged 2 cols - Gold
    { devta: 'Svitra', zone: 'SSE', energy: 'positive', color: '#FFD700' },
    { devta: 'Bhrusha', zone: 'SE', energy: 'neutral', color: '#FFE87C' }, // Light Gold
  ],
  // Row 7
  [
    { devta: 'Dwarika', zone: 'WSW', energy: 'neutral', color: '#FFE87C' }, // Light Gold
    { devta: 'Indra', zone: 'SW', energy: 'neutral', color: '#FFE87C' }, // Merged 2 cols - Light Gold
    { devta: 'Indra', zone: 'SW', energy: 'neutral', color: '#FFE87C' },
    { devta: 'Vivaswan', zone: 'S', energy: 'positive', color: '#FFBF00' }, // Merged continues - Amber
    { devta: 'Vivaswan', zone: 'S', energy: 'positive', color: '#FFBF00' },
    { devta: 'Vivaswan', zone: 'S', energy: 'positive', color: '#FFBF00' },
    ...
    { devta: 'Aakash', zone: 'SE', energy: 'neutral', color: '#FFE87C' }, // Light Gold
  ],
  // Row 8 (South - bottom row)
  [
    { devta: 'Pitru Gana', zone: 'SW', energy: 'negative', color: '#F0A500' }, // Honey Gold
    { devta: 'Mriga', zone: 'SSW', energy: 'neutral', color: '#FFE87C' }, // Light Gold
    { devta: 'Bhringaraj', zone: 'SSW', energy: 'negative', color: '#F0A500' }, // Honey Gold
    ...
    { devta: 'Bhratsata', zone: 'S', energy: 'neutral', color: '#FFF8DC' }, // Cornsilk (pastel)
